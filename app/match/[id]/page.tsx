      ...
      <section className="px-4 py-8" style={{ backgroundColor: theme.bgSecondary }}>
        <div className="flex items-center justify-between">
          ...
          <div className="flex-1 text-center">
            ...
            <div className="flex flex-col items-center">
              <div className="flex items-center justify-center gap-1">
                <p className="text-sm font-medium text-center" style={{ color: theme.text }}>{match.home.name}</p>
              ...
              <p className="text-[10px] text-center" style={{ color: theme.textSecondary }}>{match.home.shortName}</p>
            </div>
          ...
          <div className="flex-1 text-center">
            ...
            <div className="flex flex-col items-center">
              <div className="flex items-center justify-center gap-1">
                <p className="text-sm font-medium text-center" style={{ color: theme.text }}>{match.away.name}</p>
              ...
              <p className="text-[10px] text-center" style={{ color: theme.textSecondary }}>{match.away.shortName}</p>
            </div>
