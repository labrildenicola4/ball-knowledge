                  ...
                  >
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          className="rounded-full px-2.5 py-0.5 text-xs glass-card"
                          style={{ color: theme.textSecondary }}
                        >
            ...
            {standingsLoading ? (
              ...
              <>
                ...
                <div className="flex gap-2 mb-4">
                  {(['AL', 'NL'] as const).map((league) => (
                    <button
                      ...
                      className={`tap-highlight flex-1 py-2.5 rounded-lg text-sm font-medium transition-colors ${selectedLeague === league ? 'glass-pill-active' : 'glass-pill'}`}
                      style={{ color: selectedLeague === league ? '#fff' : theme.textSecondary }}
                    >
                ...
                {standingsData?.standings?.length === 0 && (
                  <div
                    className="rounded-lg px-4 py-3 mb-4 text-center text-sm glass-card"
                    style={{ color: theme.textSecondary }}
                  >
                  ...
                  {(standingsData?.standings?.length === 0 ? getOffseasonDivisions(selectedLeague) : currentDivisions).map((division) => {
                    ...
                    return (
                      ...
                      >
                        {/* Division Header */}
                        <div
                          className="px-4 py-2.5 text-[11px] font-semibold uppercase glass-card"
                          style={{ color: theme.textSecondary }}
                        >
                          ...
                          (teams as MLBStanding[]).map((team, index) => (
                            <div key={team.team.id}>
                              ...
                              {index === 0 && (teams as MLBStanding[]).length > 1 && (
                                <div className="flex items-center gap-2 px-4 py-1.5 glass-card">
