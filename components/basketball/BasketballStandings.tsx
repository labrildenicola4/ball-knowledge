      ...
      >
        ...
        {standings.map((standing, index) => (
          ...
          >
            ...
            >
              {standing.team.logo && (
                <img src={standing.team.logo} alt={standing.team.name} className="h-5 w-5 object-contain" />
              )}
      ...
      >
        ...
        {standings.map((standing, index) => (
          ...
          >
            ...
            >
              {standing.team.logo && (
                <img src={standing.team.logo} alt={standing.team.name} className="h-6 w-6 object-contain" />
              )}
      ...
      >
        ...
        {rankings.map((ranking) => (
          ...
          >
            ...
            >
              {ranking.team.logo && (
                <img src={ranking.team.logo} alt={ranking.team.name} className="h-5 w-5 object-contain" />
              )}
